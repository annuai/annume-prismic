...
interface PostsDocumentData {
    ...
    /**
     * Publish Date field in *Posts*
     *
     * - **Field Type**: Date
     * - **Placeholder**: *None*
     * - **API ID Path**: posts.publishDate
     * - **Tab**: Main
     * - **Documentation**: https://prismic.io/docs/core-concepts/date
     *
     */
    publishDate: prismicT.DateField;
    /**
     * Featured Image field in *Posts*
     *
     * - **Field Type**: Image
     * - **Placeholder**: *None*
     * - **API ID Path**: posts.featuredImage
     * - **Tab**: Main
     * - **Documentation**: https://prismic.io/docs/core-concepts/image
     *
     */
 ...
 *
 */
type PostsDocumentDataSlicesSlice = ImageSlice | QuoteSlice | TextSlice;
/**
...
export type AllDocumentTypes = ArticleDocument | NavigationDocument | PageDocument | PostsDocument | SettingsDocument;
/**
